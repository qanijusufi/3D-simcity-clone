...
export class Game {
  ...
  constructor(city) {
    ...
    window.assetManager = new AssetManager(() => {
      ...
      setInterval(this.simulate.bind(this), 1000); // interval of animation
    });
   ...
   */
  #setupLights() {
    const sun = new THREE.DirectionalLight(0xffffff, 2); //intensity higher or lower
    ...
    this.scene.add(sun);
    this.scene.add(new THREE.AmbientLight(0xffffff, 0.5)); //intensity higher or lower
  }
